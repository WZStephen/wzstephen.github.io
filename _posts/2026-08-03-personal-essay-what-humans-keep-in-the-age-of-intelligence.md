...
eyebrow: 'AI 与人'
description: '当智能越来越便宜，人仍需要保留理解事实、追问因果、验证结果和决定方向的能力。'
thesis: '我并不认为人必须拒绝 AI，才能保住自己的能力。更重要的是把 AI 当成一种加速器，而不是把理解过程完全外包出去。'
visual_center: '人'
visual_terms: ['理解', '判断', '责任']
visual_caption: '机器扩展智能，人继续承担理解、判断与方向选择'
---
