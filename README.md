...
- `resume/index.html`: redirect/fallback page for the English PDF resume.
- `resume/index-cn.html`: redirect/fallback page for the Chinese PDF resume.
- `resume/pdf-source.html`: source HTML for generating the English PDF resume.
- `resume/pdf-source-cn.html`: source HTML for generating the Chinese PDF resume.
...
```bash
google-chrome --headless --disable-gpu --no-sandbox --no-pdf-header-footer --print-to-pdf=Files/EN_Resume_Weichi_Zhao.pdf resume/pdf-source.html
google-chrome --headless --disable-gpu --no-sandbox --no-pdf-header-footer --print-to-pdf=Files/CN_Resume_Weichi_Zhao.pdf resume/pdf-source-cn.html
```
